...
import pandas as pd
from scripts.config import LOCALPATH
...
class stockData():
    ...
    def execute_query(**kwargs):
        ...
        df_aapl=pd.read_csv("{}/finance_data/{}/data_aapl.csv".format(LOCALPATH,execution_date))
        ...
        df_tsla=pd.read_csv("{}/finance_data/{}/data_tsla.csv".format(LOCALPATH,execution_date))
